...
import content from '../../../locales/en/terms-of-service.json';
            ...
            <div className="bg-white rounded-lg shadow-sm p-8">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <p className="text-sm text-gray-600 text-center">
                  These terms were last updated on {content.lastUpdated}.
                  By using SalaryWise.io, you agree to these terms.
                </p>
              </div>
            </div>
          </div>
